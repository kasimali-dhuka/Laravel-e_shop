<div>
    ...
    <div class="row">
                ...
                <div class="input-group input-group-static mb-3">
                    <select name="category_id" id="category_id" class="form-control" aria-label="Default select example" value="{{ old('category_id', optional($data ?? null)->category_id) }}">
                        ...
                        @forelse ($attributes['categories'] as $category)
                            @if (old('category_id', optional($data ?? null)->category_id) == $category->id)                                
        ...
        @if ($form==='products')
            <div class="col-md-6">
                <div class="input-group input-group-outline mb-3 {{ !$errors->has('original_price')?'':'is-invalid' }}">
            ...
            <div class="col-md-6">
                <div class="input-group input-group-outline mb-3 {{ !$errors->has('selling_price')?'':'is-invalid' }}">
            ...
            <div class="col-md-6">
                <div class="input-group input-group-outline mb-3 {{ !$errors->has('qty')?'':'is-invalid' }}">
            ...
            <div class="col-md-6">
                <div class="input-group input-group-outline mb-3 {{ !$errors->has('tax')?'':'is-invalid' }}">
        ...
        <div class="col-md-12">
            <div class="input-group input-group-outline mb-3 {{ !$errors->has('meta_description')?'':'is-invalid' }}">
                ...
                >{{ old('meta_description', optional($data ?? null)->meta_description) }}</textarea>
